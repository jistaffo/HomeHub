...
const DEFAULT_TYPES = {
  ...
  utility:  { label: "Utility / Laundry",  tag: false, w: 5,   h: 6,  group: "circulation" },
...
const STYLE = `
  ...
  *{box-sizing:border-box;}
  ...
  .piece .content{position:absolute; inset:0; display:flex; flex-direction:column; padding:5px 7px; overflow:hidden; pointer-events:none;}
  .piece .label{font-weight:600; font-size:12px; line-height:1.2;}
...
class RoomPlannerElement extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this._els.subheading.textContent =
      ...
      "Drag a piece to move it. Drag any edge to extend or widen just that side, or a corner to resize both directions. Click a piece to rename it or type exact feet. Each grid cell is 1 sq ft.";
